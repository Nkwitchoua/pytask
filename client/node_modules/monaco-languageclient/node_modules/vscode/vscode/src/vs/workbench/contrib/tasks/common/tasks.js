...
const TASK_RUNNING_STATE = ( new RawContextKey('taskRunning', false, ( nls.localizeWithPath(
    'vs/workbench/contrib/tasks/common/tasks',
    'tasks.taskRunningContext',
    "Whether a task is currently running."
))));
const TASKS_CATEGORY = { value: ( nls.localizeWithPath('vs/workbench/contrib/tasks/common/tasks', 'tasksCategory', "Tasks")), original: 'Tasks' };
var ShellQuoting;
