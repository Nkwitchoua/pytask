...
import { h, Dimension, runAtThisOrScheduleAtNextAnimationFrame, getWindow } from 'monaco-editor/esm/vs/base/browser/dom.js';
...
import { lineRangeAsRange, invertLineRange } from './utils.js';
...
let InlineChatLivePreviewWidget = class InlineChatLivePreviewWidget extends ZoneWidget {
    ...
    _renderInsertWithHighlight(changes) {
    ...
    _renderChangesWithFullDiff(changes) {
        assertType(this.editor.hasModel());
    ...
    _computeHiddenRanges(model, changes) {
