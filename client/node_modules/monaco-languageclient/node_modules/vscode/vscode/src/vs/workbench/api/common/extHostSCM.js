...
import { isLinux } from 'monaco-editor/esm/vs/base/common/platform.js';
var ExtHostSCM_1;
...
function getSourceControlInputBoxValueProviderIcon(provider) {
    if (!provider.icon) {
        return undefined;
    }
...
class ExtHostSCMInputBox {
    ...
    constructor(_extension, _commands, _extHostDocuments, proxy, _sourceControlHandle, _documentUri) {
...
class ExtHostSourceControl {
    ...
    constructor(_extension, _extHostDocuments, proxy, _commands, _id, _label, _rootUri) {
        ...
        this._historyProviderActionButtonDisposable = ( new MutableDisposable());
...
let ExtHostSCM = class ExtHostSCM {
    ...
    static { this._handlePool = 0; }
    static { this._inputBoxValueProviderHandlePool = 0; }
    ...
    constructor(mainContext, _commands, _extHostDocuments, logService) {
        ...
        this._inputBoxValueProviders = ( new Map());
    ...
    registerSourceControlInputBoxValueProvider(extension, sourceControlId, provider) {
        this.logService.trace('ExtHostSCM#registerSourceControlInputBoxValueProvider', extension.identifier.value, provider.label);
        const handle = ExtHostSCM_1._inputBoxValueProviderHandlePool++;
    ...
    async $provideInputBoxValue(inputBoxValueProviderHandle, rootUri, context, token) {
