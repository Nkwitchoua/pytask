...
import { matchesScheme, Schemas } from 'monaco-editor/esm/vs/base/common/network.js';
...
function createApiFactoryAndRegisterActors(accessor) {
    ...
    return function (extension, extensionInfo, configProvider) {
        ...
        const scm = {
            ...
            registerSourceControlInputBoxValueProvider(sourceControlId, provider) {
        ...
        return {
            ...
            ChatAgentResultFeedbackKind: ChatAgentResultFeedbackKind,
