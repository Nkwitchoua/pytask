...
import { IsAuxiliaryWindowFocusedContext, IsCenteredLayoutContext, MainEditorAreaVisibleContext, PanelAlignmentContext, PanelPositionContext, SideBarVisibleContext, InEditorZenModeContext, FocusedViewContext, AuxiliaryBarVisibleContext, PanelVisibleContext, IsFullscreenContext } from '../../common/contextkeys.js';
...
class HideEditorTabsAction extends Action2 {
...
class ShowMultipleEditorTabsAction extends Action2 {
...
class ShowSingleEditorTabAction extends Action2 {
...
class EditorActionsTitleBarAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            category: Categories.View,
            precondition: ( ContextKeyExpr.and(( ( ContextKeyExpr.equals('config.workbench.editor.editorActionsLocation', 'titleBar')).negate()), ( ( ContextKeyExpr.equals('config.window.style', 'native')).negate()))),
            f1: true
        });
    }
    run(accessor) {
...
ToggleVisibilityActions.push(...[
    CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ( ContextKeyExpr.equals('config.workbench.activityBar.visible', true)), ( localizeWithPath(
        'vs/workbench/browser/actions/layoutActions',
        'activityBar',
        "Activity Bar"
...
export { EditorActionsDefaultAction, EditorActionsTitleBarAction, HideEditorActionsAction, HideEditorTabsAction, ShowEditorActionsAction, ShowMultipleEditorTabsAction, ShowSingleEditorTabAction, ToggleActivityBarVisibilityActionId, ToggleSidebarPositionAction, ToggleStatusbarVisibilityAction };
