...
import { MenuId, Action2, registerAction2, MenuRegistry } from 'monaco-editor/esm/vs/platform/actions/common/actions.js';
import { KeyChord } from 'monaco-editor/esm/vs/base/common/keyCodes.js';
import { IsAuxiliaryWindowFocusedContext, IsFullscreenContext } from '../../common/contextkeys.js';
import { IsDevelopmentContext, IsWebContext, IsIOSContext, IsMacNativeContext } from 'monaco-editor/esm/vs/platform/contextkey/common/contextkeys.js';
...
import { isMacintosh, isWeb, isWindows } from 'monaco-editor/esm/vs/base/common/platform.js';
...
import { getActiveWindow, getActiveElement } from 'monaco-editor/esm/vs/base/browser/dom.js';
...
class ShowAboutDialogAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                value: ( localizeWithPath('vs/workbench/browser/actions/windowActions', 'about', "About")),
                mnemonicTitle: ( localizeWithPath(
                    'vs/workbench/browser/actions/windowActions',
...
class NewWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                value: ( localizeWithPath('vs/workbench/browser/actions/windowActions', 'newWindow', "New Window")),
                mnemonicTitle: ( localizeWithPath(
                    'vs/workbench/browser/actions/windowActions',
