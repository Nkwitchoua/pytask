...
class NotebookOptions extends Disposable {
    constructor(configurationService, notebookExecutionStateService, isReadonly, overrides) {
        ...
        const stickyScroll = overrides?.stickyScroll ?? this.configurationService.getValue(NotebookSetting.stickyScroll) ?? false;
    ...
    _updateConfiguration(e) {
        ...
        if (stickyScroll && this.overrides?.stickyScroll === undefined) {
            configuration.stickyScroll = this.configurationService.getValue(NotebookSetting.stickyScroll) ?? false;
        }
...
export { NotebookOptions, OutputInnerContainerTopPadding, getEditorTopPadding, updateEditorTopPadding };
