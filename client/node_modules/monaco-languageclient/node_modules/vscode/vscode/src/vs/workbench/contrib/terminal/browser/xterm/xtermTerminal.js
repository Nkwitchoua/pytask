...
let XtermTerminal = class XtermTerminal extends Disposable {
    ...
    *getBufferReverseIterator() {
    ...
    clearBuffer() {
        ...
        this._accessibleNotificationService.notify("clear" );
    }
    hasSelection() {
...
XtermTerminal = XtermTerminal_1 = ( __decorate([
    ...
    ( __param(18, IAccessibleNotificationService)),
    ( __param(19, ILayoutService))
], XtermTerminal));
