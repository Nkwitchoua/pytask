...
import { SequencerByKey, DeferredPromise } from 'monaco-editor/esm/vs/base/common/async.js';
...
import { Disposable, DisposableStore, combinedDisposable, dispose, toDisposable } from 'monaco-editor/esm/vs/base/common/lifecycle.js';
...
import { registerColor, transparent, listInactiveSelectionBackground, focusBorder, errorForeground, foreground, contrastBorder, scrollbarSliderBackground, scrollbarSliderHoverBackground, scrollbarSliderActiveBackground } from 'monaco-editor/esm/vs/platform/theme/common/colorRegistry.js';
...
import { DropIntoEditorController } from 'monaco-editor/esm/vs/editor/contrib/dropOrPasteInto/browser/dropIntoEditorController.js';
import { CopyPasteController } from 'monaco-editor/esm/vs/editor/contrib/dropOrPasteInto/browser/copyPasteController.js';
