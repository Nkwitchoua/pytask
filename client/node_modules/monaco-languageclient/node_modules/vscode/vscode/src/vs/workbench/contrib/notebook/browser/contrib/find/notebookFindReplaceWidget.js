...
import { SimpleButton, findPreviousMatchIcon, findNextMatchIcon, findReplaceIcon, findReplaceAllIcon } from 'monaco-editor/esm/vs/editor/contrib/find/browser/findWidget.js';
import * as nls from 'monaco-editor/esm/vs/nls.js';
import { ContextScopedReplaceInput, registerAndCreateHistoryNavigationContext } from 'monaco-editor/esm/vs/platform/history/browser/contextScopedHistoryWidget.js';
...
import { parseReplaceString, ReplacePattern } from 'monaco-editor/esm/vs/editor/contrib/find/browser/replacePattern.js';
...
import { defaultProgressBarStyles, defaultInputBoxStyles, defaultToggleStyles } from 'monaco-editor/esm/vs/platform/theme/browser/defaultStyles.js';
...
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( nls.localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'label.toggleReplaceButton',
    "Toggle Replace"
));
const NLS_REPLACE_INPUT_LABEL = ( nls.localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'label.replace',
    "Replace"
));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( nls.localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'placeholder.replace',
    "Replace"
));
const NLS_REPLACE_BTN_LABEL = ( nls.localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'label.replaceButton',
    "Replace"
));
const NLS_REPLACE_ALL_BTN_LABEL = ( nls.localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
