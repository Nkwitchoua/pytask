...
class MenuBar extends Disposable {
    ...
    createOverflowMenu() {
        const label = this.isCompact ? ( nls.localizeWithPath('vs/base/browser/ui/menu/menubar', 'mAppMenu', 'Application Menu')) : ( nls.localizeWithPath('vs/base/browser/ui/menu/menubar', 'mMore', 'More'));
