...
class CellFocusIndicator extends CellContentPart {
    constructor(notebookEditor, titleToolbar, top, left, right, bottom) {
        ...
        this.codeFocusIndicator = ( new FastDomNode(
            dom.append(this.left.domNode, dom.$('.codeOutput-focus-indicator-container', undefined, dom.$('.codeOutput-focus-indicator.code-focus-indicator')))
        ));
        this.outputFocusIndicator = ( new FastDomNode(
            dom.append(this.left.domNode, dom.$('.codeOutput-focus-indicator-container', undefined, dom.$('.codeOutput-focus-indicator.output-focus-indicator')))
        ));
