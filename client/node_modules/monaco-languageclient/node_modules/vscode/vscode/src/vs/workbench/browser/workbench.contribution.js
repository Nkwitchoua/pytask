...
import { DynamicWorkbenchConfigurationWorkbenchContribution, workbenchConfigurationNodeBase, Extensions as Extensions$1 } from '../common/configuration.js';
import { isStandalone } from 'monaco-editor/esm/vs/base/browser/browser.js';
import { Extensions } from '../common/contributions.js';
const registry = ( Registry.as(Extensions$2.Configuration));
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'workbench.editor.tabActionLocation': {
                ...
                markdownDescription: ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'tabActionLocation' },
