...
let ViewsService = class ViewsService extends Disposable {
    ...
    getFocusedViewName() {
        ...
        const textEditorFocused = this.editorService.activeTextEditorControl?.hasTextFocus() ? ( localizeWithPath('vs/workbench/browser/parts/views/viewsService', 'editor', "Text Editor")) : undefined;
