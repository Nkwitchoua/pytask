...
( (function(IFileCoverage) {
    ...
    IFileCoverage.deserialize = (serialized) => ({
...
( (function(CoverageDetails) {
    CoverageDetails.serialize = (original) => original.type === 0  ? IFunctionCoverage.serialize(original) : IStatementCoverage.serialize(original);
    CoverageDetails.deserialize = (serialized) => serialized.type === 0  ? IFunctionCoverage.deserialize(serialized) : IStatementCoverage.deserialize(serialized);
...
})(IFunctionCoverage || (IFunctionCoverage = {})));
