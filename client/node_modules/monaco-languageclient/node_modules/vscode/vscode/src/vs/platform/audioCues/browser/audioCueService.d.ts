...
declare class AudioCue {
    ...
    static readonly clear: AudioCue;
    static readonly save: AudioCue;
    static readonly format: AudioCue;
    private constructor();
}

export { AudioCue, type IAudioCueOptions, IAudioCueService, Sound, SoundSource };
