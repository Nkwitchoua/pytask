...
class AbstractVariableResolverService {
    ...
    async evaluateSingleVariable(environment, match, variable, folderUri, commandValueMapping) {
        ...
        const getFolderPathForFile = (variableKind) => {
            ...
            throw new VariableError(variableKind, localizeWithPath('vs/workbench/services/configurationResolver/common/variableResolver', 'canNotResolveFolderForFile', "Variable {0}: can not find workspace folder of '{1}'.", match, path.basename(filePath)));
        };
            ...
            default: {
                switch (variable) {
                    ...
                    case 'fileWorkspaceFolderBasename':
                        return path.basename(getFolderPathForFile(VariableKind.FileWorkspaceFolderBasename));
                    case 'relativeFile':
