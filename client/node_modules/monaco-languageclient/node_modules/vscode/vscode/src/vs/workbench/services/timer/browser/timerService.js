...
import * as performance$1 from 'monaco-editor/esm/vs/base/common/performance.js';
...
import { Barrier, timeout } from 'monaco-editor/esm/vs/base/common/async.js';
import { IWorkbenchLayoutService } from '../../layout/browser/layoutService.js';
import { IPaneCompositePartService } from '../../panecomposite/browser/panecomposite.js';
import { TelemetryTrustedValue } from '../../../../platform/telemetry/common/telemetryUtils.js';
import { isWeb } from 'monaco-editor/esm/vs/base/common/platform.js';
import { createBlobWorker } from 'monaco-editor/esm/vs/base/browser/defaultWorkerFactory.js';
...
let AbstractTimerService = class AbstractTimerService {
    constructor(_lifecycleService, _contextService, _extensionService, _updateService, _paneCompositeService, _editorService, _accessibilityService, _telemetryService, layoutService) {
        ...
        Promise.all([
            ...
            this.setPerformanceMarks('renderer', performance$1.getMarks());
