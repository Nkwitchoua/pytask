...
import { Disposable, DisposableStore, MutableDisposable, combinedDisposable, toDisposable } from 'monaco-editor/esm/vs/base/common/lifecycle.js';
...
import { IChatWidgetService, IChatAccessibilityService } from './chat.js';
import { ChatInputPart } from './chatInputPart.js';
import { ChatListDelegate, ChatListItemRenderer, ChatAccessibilityProvider } from './chatListRenderer.js';
import { ChatEditorOptions } from './chatOptions.js';
import { CONTEXT_IN_CHAT_SESSION, CONTEXT_CHAT_REQUEST_IN_PROGRESS, CONTEXT_RESPONSE_FILTERED } from '../common/chatContextKeys.js';
...
let ChatWidget = class ChatWidget extends Disposable {
    ...
    constructor(viewContext, viewOptions, styles, contextKeyService, instantiationService, chatService, chatWidgetService, contextMenuService, _chatAccessibilityService, _instantiationService, _logService) {
        super();
    ...
    createList(listContainer, options) {
        ...
        this.renderer = this._register(scopedInstantiationService.createInstance(ChatListItemRenderer, this.editorOptions, options, rendererDelegate));
...
ChatWidgetService = ( __decorate([
    ...
    ( __param(1, IChatContributionService))
], ChatWidgetService));
