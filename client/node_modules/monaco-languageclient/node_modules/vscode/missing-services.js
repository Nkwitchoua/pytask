...
import { IInlineChatSessionService } from './vscode/src/vs/workbench/contrib/inlineChat/browser/inlineChatSession.js';
import { IWalkthroughsService } from './vscode/src/vs/workbench/contrib/welcomeGettingStarted/browser/gettingStartedService.js';
import { IFeaturedExtensionsService } from './vscode/src/vs/workbench/contrib/welcomeGettingStarted/browser/featuredExtensionService.js';
...
registerSingleton(IProductService, class ProductService {
    constructor() {
        this._serviceBrand = undefined;
        this.version = "1.85.0";
        this.commit = "af28b32d7e553898b2a91af498b1fb666fdebe0c";
        this.quality = 'oss';
...
registerSingleton(IFeaturedExtensionsService, class FeaturedExtensionsService {
    constructor() {
        this.getExtensions = unsupported;
    }
    get title() {
